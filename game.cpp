    ...
    void cleanUp(MainCharacter* dunn, MainCharacter* ronaldo, GameObject* ball, Monster* bat ) {
        ...
        SDL_DestroyTexture(upball);SDL_DestroyTexture(upthrough);SDL_DestroyTexture(upjump);SDL_DestroyTexture(stop);
    ...
    void Click(SDL_Event& event, int& score)
    {
    ...
    void RenderScoreAndFeature()
    {
        ...
        graphics.renderTexture(upspeed, SCREEN_WIDTH - 80, 127, 60, 60);
        graphics.renderTexture(upball, SCREEN_WIDTH - 80, 187, 60, 60);
        graphics.renderTexture(upthrough, SCREEN_WIDTH - 80, 247, 60, 60);
        graphics.renderTexture(upjump, SCREEN_WIDTH - 80, 307, 60, 60);
